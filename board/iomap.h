...
#define GPIOA_PA1_OE_N                        1U
#define GPIOA_PA2_PULSE_1                     2U
#define GPIOA_PA3_PULSE_2                     3U
#define GPIOA_PA4_DIR_1                       4U
#define GPIOA_PA5_DIR_2                       5U
#define GPIOA_PA6_NC                          6U
#define GPIOA_PA7_MEAS_VBAT                   7U
#define GPIOA_PA8_NC                          8U
#define GPIOA_PA9_NC                          9U
...
#define GPIOC_PC8_LEDGRN                      8U
#define GPIOC_PC9_LEDRED                      9U
#define GPIOC_PC10_IN_1                       10U
#define GPIOC_PC11_IN_2                       11U
#define GPIOC_PC12_IN_3                       12U
 ...
 */
#define LINE_OE_N                             PAL_LINE(GPIOA, 1U)
#define LINE_PULSE_1                          PAL_LINE(GPIOA, 2U)
#define LINE_PULSE_2                          PAL_LINE(GPIOA, 3U)
#define LINE_DIR_1                            PAL_LINE(GPIOA, 4U)
#define LINE_DIR_2                            PAL_LINE(GPIOA, 5U)
#define LINE_MEAS_VBAT                        PAL_LINE(GPIOA, 7U)
...
#define LINE_IN_4                             PAL_LINE(GPIOB, 11U)
#define LINE_LEDGRN                           PAL_LINE(GPIOC, 8U)
#define LINE_LEDRED                           PAL_LINE(GPIOC, 9U)
#define LINE_IN_1                             PAL_LINE(GPIOC, 10U)
#define LINE_IN_2                             PAL_LINE(GPIOC, 11U)
#define LINE_IN_3                             PAL_LINE(GPIOC, 12U)
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_PA0_NC) | \
                                     ...
                                     PIN_MODE_ANALOG(GPIOA_PA7_MEAS_VBAT) | \
                                     PIN_MODE_INPUT(GPIOA_PA8_NC) | \
                                     PIN_MODE_INPUT(GPIOA_PA9_NC) | \
...
#define VAL_GPIOC_MODER             (PIN_MODE_INPUT(GPIOC_PC0_NC) | \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOC_PC8_LEDGRN) | \
                                     PIN_MODE_OUTPUT(GPIOC_PC9_LEDRED) | \
                                     PIN_MODE_INPUT(GPIOC_PC10_IN_1) | \
                                     PIN_MODE_INPUT(GPIOC_PC11_IN_2) | \
                                     PIN_MODE_INPUT(GPIOC_PC12_IN_3) | \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_PA0_NC) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA1_OE_N) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA2_PULSE_1) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA3_PULSE_2) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA4_DIR_1) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA5_DIR_2) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA6_NC) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA7_MEAS_VBAT) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA8_NC) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA9_NC) | \
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_PC0_NC) | \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOC_PC8_LEDGRN) | \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PC9_LEDRED) | \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PC10_IN_1) | \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PC11_IN_2) | \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PC12_IN_3) | \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_LOW(GPIOA_PA0_NC) | \
                                     PIN_OSPEED_LOW(GPIOA_PA1_OE_N) | \
                                     PIN_OSPEED_LOW(GPIOA_PA2_PULSE_1) | \
                                     PIN_OSPEED_LOW(GPIOA_PA3_PULSE_2) | \
                                     PIN_OSPEED_LOW(GPIOA_PA4_DIR_1) | \
                                     PIN_OSPEED_LOW(GPIOA_PA5_DIR_2) | \
                                     PIN_OSPEED_LOW(GPIOA_PA6_NC) | \
                                     PIN_OSPEED_LOW(GPIOA_PA7_MEAS_VBAT) | \
                                     PIN_OSPEED_LOW(GPIOA_PA8_NC) | \
                                     PIN_OSPEED_LOW(GPIOA_PA9_NC) | \
                                     PIN_OSPEED_LOW(GPIOA_PA10_NC) | \
                                     PIN_OSPEED_LOW(GPIOA_PA11_USART6TX) | \
                                     PIN_OSPEED_LOW(GPIOA_PA12_USART6RX) | \
                                     PIN_OSPEED_LOW(GPIOA_PA13_SWDIO) | \
                                     PIN_OSPEED_LOW(GPIOA_PA14_SWCLK) | \
                                     PIN_OSPEED_LOW(GPIOA_PA15_NC))

/*
 * GPIO Port B Output speeds
 */
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_LOW(GPIOB_PB0_NC) | \
                                     ...
                                     PIN_OSPEED_LOW(GPIOB_PB6_I2C1SCL) | \
                                     PIN_OSPEED_LOW(GPIOB_PB7_I2C1SDA) | \
                                     PIN_OSPEED_LOW(GPIOB_PB8_NC) | \
                                     PIN_OSPEED_LOW(GPIOB_PB9_NC) | \
                                     PIN_OSPEED_LOW(GPIOB_PB10_NC) | \
                                     PIN_OSPEED_LOW(GPIOB_PB11_IN_4) | \
                                     PIN_OSPEED_LOW(GPIOB_PB12_NC) | \
                                     PIN_OSPEED_LOW(GPIOB_PB13_NC) | \
                                     PIN_OSPEED_LOW(GPIOB_PB14_NC) | \
                                     PIN_OSPEED_LOW(GPIOB_PB15_NC))

/*
 * GPIO Port C Output speeds
 */
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_LOW(GPIOC_PC0_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC1_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC2_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC3_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC4_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC5_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC6_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC7_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC8_LEDGRN) | \
                                     PIN_OSPEED_LOW(GPIOC_PC9_LEDRED) | \
                                     PIN_OSPEED_LOW(GPIOC_PC10_IN_1) | \
                                     PIN_OSPEED_LOW(GPIOC_PC11_IN_2) | \
                                     PIN_OSPEED_LOW(GPIOC_PC12_IN_3) | \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_PA0_NC) | \
                                     PIN_ODR_HIGH(GPIOA_PA1_OE_N) | \
                                     PIN_ODR_LOW(GPIOA_PA2_PULSE_1) | \
                                     PIN_ODR_LOW(GPIOA_PA3_PULSE_2) | \
                                     PIN_ODR_LOW(GPIOA_PA4_DIR_1) | \
                                     PIN_ODR_LOW(GPIOA_PA5_DIR_2) | \
                                     PIN_ODR_HIGH(GPIOA_PA6_NC) | \
                                     PIN_ODR_HIGH(GPIOA_PA7_MEAS_VBAT) | \
                                     PIN_ODR_HIGH(GPIOA_PA8_NC) | \
                                     PIN_ODR_HIGH(GPIOA_PA9_NC) | \
...
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_PC0_NC) | \
                                     ...
                                     PIN_ODR_LOW(GPIOC_PC8_LEDGRN) | \
                                     PIN_ODR_HIGH(GPIOC_PC9_LEDRED) | \
                                     PIN_ODR_HIGH(GPIOC_PC10_IN_1) | \
                                     PIN_ODR_HIGH(GPIOC_PC11_IN_2) | \
                                     PIN_ODR_HIGH(GPIOC_PC12_IN_3) | \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLUP(GPIOA_PA0_NC) | \
                                     PIN_PUPDR_FLOATING(GPIOA_PA1_OE_N) | \
                                     PIN_PUPDR_FLOATING(GPIOA_PA2_PULSE_1) | \
                                     PIN_PUPDR_FLOATING(GPIOA_PA3_PULSE_2) | \
                                     PIN_PUPDR_FLOATING(GPIOA_PA4_DIR_1) | \
                                     PIN_PUPDR_FLOATING(GPIOA_PA5_DIR_2) | \
                                     PIN_PUPDR_PULLUP(GPIOA_PA6_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOA_PA7_MEAS_VBAT) | \
                                     PIN_PUPDR_PULLUP(GPIOA_PA8_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOA_PA9_NC) | \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_PULLUP(GPIOC_PC0_NC) | \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOC_PC8_LEDGRN) | \
                                     PIN_PUPDR_FLOATING(GPIOC_PC9_LEDRED) | \
                                     PIN_PUPDR_PULLUP(GPIOC_PC10_IN_1) | \
                                     PIN_PUPDR_PULLUP(GPIOC_PC11_IN_2) | \
                                     PIN_PUPDR_PULLUP(GPIOC_PC12_IN_3) | \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF_0(GPIOA_PA0_NC) | \
                                     ...
                                     PIN_AFIO_AF_0(GPIOA_PA7_MEAS_VBAT))
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF_0(GPIOA_PA8_NC) | \
                                     PIN_AFIO_AF_0(GPIOA_PA9_NC) | \
                                     PIN_AFIO_AF_0(GPIOA_PA10_NC) | \
                                     PIN_AFIO_AF_8(GPIOA_PA11_USART6TX) | \
                                     PIN_AFIO_AF_8(GPIOA_PA12_USART6RX) | \
                                     PIN_AFIO_AF_0(GPIOA_PA13_SWDIO) | \
                                     PIN_AFIO_AF_0(GPIOA_PA14_SWCLK) | \
                                     PIN_AFIO_AF_0(GPIOA_PA15_NC))

/*
 * GPIO Port B Alternate functions
 */
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF_0(GPIOB_PB0_NC) | \
                                     ...
                                     PIN_AFIO_AF_4(GPIOB_PB6_I2C1SCL) | \
                                     PIN_AFIO_AF_4(GPIOB_PB7_I2C1SDA))
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF_0(GPIOB_PB8_NC) | \
                                     PIN_AFIO_AF_0(GPIOB_PB9_NC) | \
                                     PIN_AFIO_AF_0(GPIOB_PB10_NC) | \
                                     PIN_AFIO_AF_0(GPIOB_PB11_IN_4) | \
                                     PIN_AFIO_AF_0(GPIOB_PB12_NC) | \
                                     PIN_AFIO_AF_0(GPIOB_PB13_NC) | \
                                     PIN_AFIO_AF_0(GPIOB_PB14_NC) | \
                                     PIN_AFIO_AF_0(GPIOB_PB15_NC))

/*
 * GPIO Port C Alternate functions
 */
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF_0(GPIOC_PC0_NC) | \
                                     PIN_AFIO_AF_0(GPIOC_PC1_NC) | \
                                     PIN_AFIO_AF_0(GPIOC_PC2_NC) | \
                                     PIN_AFIO_AF_0(GPIOC_PC3_NC) | \
                                     PIN_AFIO_AF_0(GPIOC_PC4_NC) | \
                                     PIN_AFIO_AF_0(GPIOC_PC5_NC) | \
                                     PIN_AFIO_AF_0(GPIOC_PC6_NC) | \
                                     PIN_AFIO_AF_0(GPIOC_PC7_NC))
#define VAL_GPIOC_AFRH              (PIN_AFIO_AF_0(GPIOC_PC8_LEDGRN) | \
                                     PIN_AFIO_AF_0(GPIOC_PC9_LEDRED) | \
                                     PIN_AFIO_AF_0(GPIOC_PC10_IN_1) | \
                                     PIN_AFIO_AF_0(GPIOC_PC11_IN_2) | \
                                     PIN_AFIO_AF_0(GPIOC_PC12_IN_3) | \
